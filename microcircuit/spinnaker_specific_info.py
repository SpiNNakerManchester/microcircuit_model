...
class SpinnakerSimulatorInfo(SpinnakerParams):
    ...
    def __init__(
            ...
            # TODO fix chip neeeded count and remove the n_boards_required
            n_synapse_cores=3, n_delay_slots=128, n_boards_required=9):
        ...
        # TODO fix chip neeeded count and remove the n_boards_required
        self.setup_params["n_boards_required"] = n_boards_required
