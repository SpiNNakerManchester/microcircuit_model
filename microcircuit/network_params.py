# Network parameters
from sim_params import NestParams, SpinnakerParams
from constants import (
    POISSON, DC, NEST_NERUON_MODEL, SPINNAKER_NEURON_MODEL, CONN_ROUTINE)
...
class NestNetworkParams(NestParams):
    ...
    def __init__(
        ...
        super(NestNetworkParams, self).__init__()
...
class SpinnakerNetworkParams(SpinnakerParams):
    ...
    def __init__(
        ...
        super(SpinnakerNetworkParams, self).__init__()
        self.parallel_safe = parallel_safe
        self.n_scaling = n_scaling
        self.k_scaling = k_scaling
        self.neuron_model = neuron_model
